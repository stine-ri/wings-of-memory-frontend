...
const HowItWorks: React.FC = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      details: "See exactly how your memorial will look before proceeding to payment.",
    ...
    },
    {
      ...
      description: "Pay KSh 500 securely via M-Pesa",
      details: "Simple, secure payment process with instant confirmation.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 lg:mb-20">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
            Create a beautiful memorial in 6 simple steps. Start with a free template and only pay for additional memorials.
          </p>
        </div>
        ...
        <div className="text-center bg-gradient-to-r from-orange-500 to-amber-500 rounded-2xl p-8 sm:p-12 text-white">
          ...
          <p className="text-orange-100 text-lg mb-6 max-w-2xl mx-auto">
            Join thousands of families who have created beautiful, lasting tributes with 4revah. 
